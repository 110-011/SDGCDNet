...
def evaluate1(pre_path, label_path):
    ...
    for i, p in enumerate(pre_imgs):
        ...
        # plt.imshow(imgLabel[0])
        # plt.show()
        # # for batch in imgLabel[0]:
        # #     img = batch
        # #     print(type(img))
...
if __name__ == '__main__':
    pre_path = '/media/user/shuju/XJ/toolbox/models/A__Paper/KD/results/{}/6:KDStructure(V,Bfeature12345)_same(2024-06-19-08-29)/'.format(DATASET)
    # pre_path = '/media/user/shuju/XJ/results/{}/A_MyModels/MyJokerbase_5_3_student_PPR/'.format(DATASET)
    # label_path = '/media/maps/shuju/JJH/ISPRS/test/{}/'.format(DATASET)
    label_path = '/media/user/shuju/data/ISPRS/test/{}/'.format(DATASET)
